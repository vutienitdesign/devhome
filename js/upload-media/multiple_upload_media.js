jQuery(document).ready(function($) {
    jQuery('body').on('click', '.poka_upload_image_button', function(e){
        e.preventDefault();
            ...
            var list_attachment = "";
            var attachment_ids = "";
            var i = button.prev().find(".product_images .item").length;
            ...
            attachments.each(function(attachment) {
                ...
                list_attachment += '<li class="item ui-sortable-handle" data-attachment_id="'+ attachment.id +'">' +
                                        '<img src="'+ attachment_url +'" />' +
                                        '<input type="hidden" value="'+attachment.id+'" name="'+ gallery_name +'['+i+']">' +
