<?php
class IartDecorateSmallController{
	private $sPath = "";
	private $sTask = "";
	private $sPage = "";
	...
	public function doAction() {
		...
		if(isset($_REQUEST['poka-type']) && $_REQUEST['poka-type'] == 'ajax'){
			...
			switch($sTask) {
				case "ajax-search-option":
					$this->ajaxSearchOption();
					break;
	...
	private function ajaxSearchOption(){
		require_once $this->sPath . '/tpl/ajax/search/option.php';
		die();
	}
}
